package Repofy.backend.controllers;
...
import Repofy.backend.dto.ChatMessageRequest;
...
import Repofy.backend.security.CurrentUser;
import Repofy.backend.services.ChatService;
