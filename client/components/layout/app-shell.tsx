...
import { RepofyIcon } from "@/components/icons/repofy-icon";
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                tooltip="Repofy"
              >
                <RepofyIcon className="size-8 rounded-[10px]" />
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">Repofy</span>
...
export function BrandMark({ className }: { className?: string }) {
  return (
    ...
    >
      <RepofyIcon className="size-8 rounded-[10px]" />
      <span className="font-heading text-[1.05rem] leading-none">Repofy</span>
    </div>
  );
}
